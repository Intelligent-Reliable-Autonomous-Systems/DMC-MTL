...
def main():
    ...
    #pheno_mean = np.nanmean(pheno_array,axis=(-3, -1))[:,-1]
    #pheno_std = np.nanstd(pheno_array,axis=(-3, -1))[:,-1]
    ...
    ax2_color = "tab:red"
    ax2 = ax.twinx()
    ax2.plot(np.arange(2), ch_mean, color=ax2_color, label="Cold-Hardiness")
