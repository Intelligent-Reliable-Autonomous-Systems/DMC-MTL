...
python3 -m trainers.train_model --config dmc_mtl/phenology/pheno_param_mtl_ff --seed 0
python3 -m trainers.train_model --config dmc_mtl/phenology/pheno_param_mtl_ff --seed 1
python3 -m trainers.train_model --config dmc_mtl/phenology/pheno_param_mtl_ff --seed 2
